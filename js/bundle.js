...
function forms(formSelector,modalTimerId) {
   ...
   const message = {
      ...
      success: 'Спасибо, мы вам передзвоним!',
...
function openModal(modalSelector,modalTimerId) {
   ...
   document.body.style.overflow = 'hidden'; //  убираем прокрутку страници
...
function closeModal(modalSelector) {
   ...
   document.body.style.overflow = ''; //  возваращаем прокрутку страници
}
